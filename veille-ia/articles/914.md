...
<h2><strong>Spatial Reasoning</strong></h2>
...
<h3><strong>Mental Rotation</strong></h3>
...
<h2><strong>Memory &amp; Adaptability</strong></h2>
...
<h3><strong>Knights and Knaves</strong></h3>
...
<h3><strong>SimpleBench</strong></h3>
...
<h2><strong>Abstract &amp; Visual Reasoning</strong></h2>
...
<h2><strong>Increasing Complexity</strong></h2>
...
<h3><strong>Logic Grid</strong></h3>
...
<p><strong>Mental Rotation: </strong><a href="https://github.com/stogiannidis/srbench/blob/main/LICENSE" referrerpolicy="no-referrer" rel="noopener noreferrer" target="_blank">CC BY 4.0</a>. Stogiannidis, Ilias, Steven McDonagh, Sotirios A. Tsaftaris. Mind the Gap: Benchmarking Spatial Reasoning in Vision-Language Models (copyright 2025); illustrations by John MacNeill. <strong>Knights &amp; knaves</strong>: Courtesy Dan MacKinnon. <strong>Simplebench</strong>: <a href="https://github.com/simple-bench/SimpleBench/blob/main/LICENSE" referrerpolicy="no-referrer" rel="noopener noreferrer" target="_blank">CC BY 4.0</a>. SimpleBench Team. The Text Benchmark in which Unspecialized Human Performance Exceeds that of Current Frontier Models (copyright 2024). <strong>ARC-AGI</strong>: Courtesy <a href="https://arcprize.org/" referrerpolicy="no-referrer" rel="noopener noreferrer" target="_blank">ARC Prize Foundation</a>. <strong>Lightning round</strong>: <a href="https://www.nature.com/articles/s43588-023-00527-x" referrerpolicy="no-referrer" rel="noopener noreferrer" target="_blank">CC BY 4.0</a>. Hagendorff, Thilo, Sarah Fabi, Michal Kosinski. Human-like intuitive behavior and reasoning biases emerged in large language models but disappeared in ChatGPT. <em>Nat Comput Sci</em> 3, 833–838 (copyright 2023). <strong>The river</strong>: Adapted from <em>Propositiones ad Acuendos Juvenes,</em> Alcuin of York (ca. 800 CE). <strong>Logic grid</strong>: <a href="https://github.com/WildEval/ZeroEval/blob/main/LICENSE" referrerpolicy="no-referrer" rel="noopener noreferrer" target="_blank">Apache License 2.0</a>. Lin, Bill Y., Ronan Le Bras, Kyle Richardson, et al. ZebraLogic: On the Scaling Limits of LLMs for Logical Reasoning (copyright 2025)</p>
